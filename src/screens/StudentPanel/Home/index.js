...
class StudentHomePanel extends React.Component {
  ...
  extendFaculty(facultyExtend) {
    ...
    this.props.history.push(`/studentHomePanel/Stu_Year/${facultyExtend}`);
...
const mapStateToProps = (state) => {
 ...
 export default connect(mapStateToProps, mapDispatchToProps)(StudentHomePanel)