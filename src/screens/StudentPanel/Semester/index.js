...
class Stu_Semester extends React.Component{
...
extendSemester(SemmsterKey1,adminFacultykey,adminYearKey){
  ...
  this.props.history.push(`/studentHomePanel/Stu_Year/Stu_Semester/Stu_course/${SemmsterKey1}/${adminYearKey}/${adminFacultykey}`);
