...
// const Demo = require('../../../../../src/sketch/examples/main').default;
...
this.imgMaker=this.imgMaker.bind(this);
...
createPaperForm(modal11){
    ...
    return(
        ...
        <ModalBody  >
        <Button className=" blue-gradient" onClick={this.imgMaker} >Create Image</Button>
...
render(){
const { modal11,modal12 ,imageEditor} = this.state;
...
{imageEditor ? <div >
  <SketchField style={{border:'1px solid black'}} width='1024px' 
                           height='768px' 
                           tool={Tools.Select} 
                           lineColor='black'
                           lineWidth={3}
